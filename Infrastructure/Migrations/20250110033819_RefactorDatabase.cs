    ...
    public partial class RefactorDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourHobbies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourHobbyId = table.Column<int>(type: "int", nullable: false),
                    Appropriate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourTypeHobbies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TourTypeHobbies_TourHobbies_TourHobbyId",
                        column: x => x.TourHobbyId,
                        principalTable: "TourHobbies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TourTypeHobbies_TourTypes_TourTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourTypeHobbies_TourHobbyId",
                table: "TourTypeHobbies",
                column: "TourHobbyId");

            migrationBuilder.CreateIndex(
                name: "IX_TourTypeHobbies_TourTypeId",
                table: "TourTypeHobbies",
                column: "TourTypeId");
